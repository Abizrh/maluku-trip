            ...
            <div className="flex-1">
              <Tabs defaultValue="overview">
                ...
                <TabsContent value="overview">
                    ...
                    <Card>
                      ...
                      <CardContent className="pt-0">
                        ...
                        <p className="text-xs text-gray-500">
                          {user.trips > 0 ? "Terakhir: 2 minggu lalu" : "Belum ada perjalanan"}
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                  ...
                  <h2 className="text-xl font-semibold mb-4">Perjalanan Mendatang</h2>
                  ...
                  {upcomingTrips.length > 0 ? (
                              ...
                              <div className="p-4 md:p-6 flex-1">
                                <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                  ...
                                  <div className="mt-2 md:mt-0">
                                    ...
                                    <div className="font-bold text-lg">Rp {trip.price.toLocaleString()}</div>
                                  </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row md:justify-between md:items-center mt-4">
                                  <div className="flex items-center mb-3 md:mb-0">
                                    <div className="w-8 h-8 rounded-full overflow-hidden mr-2">
                                      <img 
                                        src={trip.guideImage || "https://randomuser.me/api/portraits/men/85.jpg"} 
                                        alt={trip.guide}
                                        className="w-full h-full object-cover"
                                      />
                                    </div>
                                    <div>
                                      <div className="text-xs text-gray-500">Pemandu</div>
                                      <div className="text-sm font-medium">{trip.guide}</div>
                                    </div>
                                  </div>
                                  
                                  <div className="flex space-x-2">
                                    <Button size="sm" variant="outline">Detail</Button>
                                    <Button size="sm">Hubungi Pemandu</Button>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <Card className="mb-8">
                      <CardContent className="p-6 text-center">
                        ...
                        <h3 className="font-semibold mb-2">Belum Ada Perjalanan</h3>
                        <p className="text-gray-500 mb-4">
                          Anda belum memiliki perjalanan mendatang. Jelajahi destinasi dan mulai petualangan Anda!
                        </p>
                    ...
                    <Tabs defaultValue="upcoming">
                      ...
                      <TabsContent value="upcoming">
                        {upcomingTrips.length > 0 ? (
                          ...
                          <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium mb-2">Belum Ada Perjalanan</h3>
                            <p className="text-gray-500 mb-6">Anda belum memiliki perjalanan mendatang</p>
                            <Button>Jelajahi Destinasi</Button>
                          </div>
                        )}
                      </TabsContent>
                      <TabsContent value="past">
                        <div className="text-center py-12">
                          ...
                          <h3 className="text-lg font-medium mb-2">Belum Ada Perjalanan Selesai</h3>
                          <p className="text-gray-500 mb-6">Perjalanan yang telah Anda selesaikan akan muncul di sini</p>
                          <Button>Jelajahi Destinasi</Button>
                        </div>
                      </TabsContent>
                      <TabsContent value="canceled">
                        <div className="text-center py-12">
                          <Clock size={48} className="mx-auto text-gray-300 mb-4" />
                          <h3 className="text-lg font-medium mb-2">Tidak Ada Perjalanan Dibatalkan</h3>
                          <p className="text-gray-500 mb-6">Perjalanan yang dibatalkan akan muncul di sini</p>
                          <Button>Jelajahi Destinasi</Button>
                        </div>
                      </TabsContent>
                    </Tabs>
                ...
                <TabsContent value="saved">
                  <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 className="text-xl font-semibold mb-4">Destinasi Tersimpan</h2>
...
const recommendedDestinations = [
  {
    ...
    name: "Pura Uluwatu",
    location: "Bali",
    image: "https://images.unsplash.com/photo-1518002054494-3a6f94352e0d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dWx1d2F0dXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60",
    rating: 4.7,
    price: 350000,
    category: "Budaya",
  },
  {
    ...
    location: "Yogyakarta",
    image: "https://images.unsplash.com/photo-1594385880555-010f4cbc147d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cHJhbWJhbmFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",
    rating: 4.8,
    price: 320000,
    category: "Sejarah",
  },
