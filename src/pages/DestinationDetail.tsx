...
const DestinationDetail = () => {
  ...
  // Find the destination data based on the ID, or use the first destination as fallback
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-2/3">
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex items-center text-yellow-500">
                    ...
                    <span className="ml-1 text-sm text-gray-500">({destination.reviewCount} ulasan)</span>
                  </div>
                </div>
              ...
              <Tabs defaultValue="deskripsi">
                ...
                <TabsContent value="deskripsi" className="mt-6">
                  <h3 className="text-xl font-semibold mb-4">Tentang Destinasi</h3>
                  ...
                  <div className="mt-6">
                    <h4 className="text-lg font-semibold mb-3">Yang Termasuk</h4>
                ...
                <TabsContent value="ulasan" className="mt-6">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-semibold">Ulasan Pengunjung</h3>
                ...
                <TabsContent value="lokasi" className="mt-6">
                  ...
                  <div className="bg-gray-100 rounded-lg h-[300px] flex items-center justify-center mb-4">
                    ...
                    <span className="ml-2 text-gray-500">Peta akan ditampilkan di sini</span>
                  </div>
                  <h4 className="font-medium mb-2">Alamat</h4>
                  <p className="text-gray-700 mb-4">{destination.address}</p>
                  <h4 className="font-medium mb-2">Cara Menuju Lokasi</h4>
                  <p className="text-gray-700">{destination.howToGet}</p>
                </TabsContent>
              </Tabs>
            </div>
            ...
            <div className="lg:w-1/3">
              <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
                <div className="mb-4">
                  <div className="text-2xl font-bold mb-2">Rp {destination.price.toLocaleString()}</div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-gray-700">{destination.duration}</div>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <Users size={18} className="text-gray-500 mr-3" />
                    <div>
                      <div className="text-sm font-medium">Jumlah Peserta</div>
                      <div className="text-gray-700">Min {destination.minParticipants} - Max {destination.maxParticipants} orang</div>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-gray-700">{destination.availability}</div>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-gray-700">{destination.guide}</div>
                    </div>
                  </div>
                </div>

                <Button className="w-full mb-3">Pesan Sekarang</Button>
...
const destinationsData = [
  {
    ...
    howToGet: "Anda dapat mencapai Pantai Kuta dengan taksi dari Bandara Internasional Ngurah Rai (sekitar 15 menit) atau dengan berjalan kaki dari area Kuta.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "15 Mar 2023",
        comment: "Pantainya sangat indah dan bersih. Pemandunya sangat ramah dan informatif. Pengalaman yang luar biasa!"
      },
      {
        ...
        rating: 4,
        date: "2 Feb 2023",
        comment: "Saya sangat menikmati matahari terbenam di pantai ini. Sayang agak terlalu ramai di beberapa area."
      },
      {
        ...
        rating: 5,
        date: "20 Jan 2023",
        comment: "Pengalaman berselancar yang menyenangkan! Air jernih dan ombaknya cocok untuk pemula seperti saya."
      }
    ],
  },
  {
    ...
    howToGet: "Dari pusat kota Yogyakarta, Anda dapat menyewa taksi atau mengikuti tur yang menyediakan transportasi (sekitar 1-1,5 jam perjalanan).",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "20 Apr 2023",
        comment: "Pengalaman spiritual yang luar biasa. Relief-reliefnya sangat detail dan menakjubkan. Sangat direkomendasikan!"
      },
      {
        ...
        rating: 5,
        date: "12 Mar 2023",
        comment: "Matahari terbit di Borobudur adalah momen yang tak terlupakan. Pemandunya sangat berpengetahuan luas tentang sejarah candi."
      }
    ],
  },
  {
    ...
    howToGet: "Dari Sorong, Anda harus mengambil kapal cepat atau kapal tradisional ke Waisai, lalu perahu ke Pulau Wayag (sekitar 4-5 jam perjalanan total).",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "5 Jun 2023",
        comment: "Tempat paling indah yang pernah saya kunjungi! Air lautnya sangat jernih dan pemandangan dari puncak benar-benar menakjubkan."
      },
      {
        ...
        rating: 4,
        date: "22 Mei 2023",
        comment: "Pengalaman yang luar biasa, meski perjalanan kesana cukup menantang. Pastikan membawa perlengkapan yang cukup dan siap secara fisik."
      }
    ],
  },
  {
    ...
    howToGet: "Dari Ambon, naik kapal cepat ke Masohi (2 jam), lalu naik kendaraan darat ke Sawai (3 jam), diikuti perjalanan perahu ke Pantai Ora (30 menit).",
    image: "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?fit=crop&w=800&q=60",
    rating: 4.9,
    reviewCount: 124,
    price: 1200000,
    category: "Pantai",
    description: "Pantai Ora dikenal sebagai 'surga tersembunyi' di Maluku dengan pasir putih lembut dan air laut biru kristal yang menampilkan beragam kehidupan bawah laut.",
    detailedDescription: "Pantai Ora adalah salah satu pantai terindah di Indonesia dengan air laut berwarna biru toska yang sangat jernih. Pasir putihnya yang halus berbatasan langsung dengan hutan hujan tropis yang masih asri. Terumbu karang yang terletak hanya beberapa meter dari pantai menawarkan pengalaman snorkeling yang luar biasa dengan keanekaragaman hayati laut yang menakjubkan, termasuk ikan karang berwarna-warni dan berbagai jenis terumbu karang.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "10 Apr 2023",
        comment: "Pantai terindah yang pernah saya kunjungi! Air lautnya sangat jernih seperti kaca dan terumbu karangnya masih sangat sehat."
      },
      {
        ...
        rating: 5,
        date: "28 Mar 2023",
        comment: "Walaupun perjalanan cukup jauh, hasilnya sangat sepadan. Tempat yang sempurna untuk melepaskan diri dari keramaian kota."
      }
    ],
  },
  {
    ...
    howToGet: "Dari Ambon, naik pesawat kecil ke Bandaneira (1 jam) atau kapal laut (8-12 jam tergantung kondisi cuaca).",
    image: "https://images.unsplash.com/photo-1518495973542-4542c06a5843?fit=crop&w=800&q=60",
    rating: 4.7,
    reviewCount: 98,
    price: 900000,
    category: "Sejarah",
    description: "Kepulauan Banda adalah pusat perdagangan rempah-rempah bersejarah dengan benteng kolonial, kebun pala, dan keindahan bawah laut yang menakjubkan.",
    detailedDescription: "Kepulauan Banda memiliki peran penting dalam sejarah perdagangan rempah dunia, khususnya pala yang dulu berharga lebih mahal dari emas. Kawasan ini memiliki benteng-benteng peninggalan kolonial Belanda yang terawat baik, seperti Benteng Belgica dan Nassau. Pengunjung dapat menjelajahi kebun pala tradisional, museum lokal, dan rumah-rumah tua bergaya kolonial. Selain nilai sejarahnya, Banda juga menawarkan keindahan bawah laut yang spektakuler untuk snorkeling dan diving, dengan dinding karang vertikal yang terjal dan keanekaragaman hayati laut yang luar biasa.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "12 Mei 2023",
        comment: "Perjalanan yang penuh dengan nilai sejarah dan keindahan alam. Sangat direkomendasikan bagi pencinta sejarah dan diving!"
      },
      {
        ...
        rating: 4,
        date: "3 Apr 2023",
        comment: "Bangunan kolonialnya sangat terawat dan pemandunya sangat berpengetahuan. Jangan lewatkan mencoba makanan lokalnya yang khas."
      }
    ],
  },
  {
    ...
    reviews: [
      {
        ...
        rating: 4,
        date: "25 Jul 2023",
        comment: "Pengalaman budaya yang mendalam dan berbeda dari tempat wisata lainnya. Pemandunya sangat menghormati tradisi lokal."
      },
      {
        ...
        rating: 5,
        date: "10 Jun 2023",
        comment: "Tempat yang luar biasa untuk belajar tentang budaya Indonesia yang beragam. Pemandangan alamnya juga sangat indah."
      }
    ],
  }
];
