              ...
              <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div className="flex flex-col items-center text-center mb-6">
                  ...
                  <div className="flex items-center mt-1 mb-1">
                    <Badge variant="outline" className="bg-jelajah-orange/10 text-jelajah-orange mr-2">
                      Pengelola Wisata
                    </Badge>
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/destination/add" className="flex items-center py-2 px-3 rounded-lg hover:bg-gray-100">
                    <Building size={18} className="mr-3 text-jelajah-blue" />
                    <span>Destinasi</span>
                  </Link>
                  <Link to="/guide/invite" className="flex items-center py-2 px-3 rounded-lg hover:bg-gray-100">
            ...
            <div className="flex-1">
              <Tabs defaultValue="overview">
                ...
                <TabsContent value="overview">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <Card>
                      ...
                      <CardContent className="pt-0">
                        <div className="text-2xl font-bold">{manager.destinations}</div>
                    ...
                    <Card>
                      ...
                      <CardContent className="pt-0">
                        <div className="text-2xl font-bold">{manager.activeBookings}</div>
                        <p className="text-xs text-gray-500">
                    ...
                    <Card>
                      ...
                      <CardContent className="pt-0">
                        <div className="text-2xl font-bold">Rp {manager.totalEarnings.toLocaleString()}</div>
                        <p className="text-xs text-gray-500">
                  ...
                  <h2 className="text-xl font-semibold mb-4">Kinerja Destinasi</h2>
                  <Card className="mb-8">
                    <CardContent className="p-6">
                      <div className="h-[240px] flex items-center justify-center">
                        <BarChart3 size={80} className="text-gray-300" />
                        <div className="ml-4 text-gray-500">
                          <h3 className="font-medium">Data Grafik Kinerja Destinasi</h3>
                          <p className="text-sm">Menampilkan statistik pengunjung dan pendapatan per destinasi</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                          ...
                          {topDestinations.map((destination, index) => (
                            <div key={index} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                              ...
                              <div className="text-right">
                                <div className="font-semibold">{destination.visitCount}</div>
                                <div className="text-xs text-gray-500">pengunjung</div>
                              </div>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="space-y-4">
                          {topGuides.map((guide, index) => (
                            <div key={index} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                              ...
                              <div className="text-right">
                                <div className="font-semibold">{guide.tourCount}</div>
                                <div className="text-xs text-gray-500">tur bulan ini</div>
                              </div>
                            </div>
                          ))}
                        </div>
                ...
                <TabsContent value="destinations">
                  <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div className="space-y-4">
                      {managedDestinations.map((destination, index) => (
                        <Card key={index}>
                              ...
                              <div className="p-4 md:p-6 flex-1">
                                <div className="flex flex-col md:flex-row md:items-start md:justify-between">
                                  <div>
                                    <div className="flex items-center mb-2">
                                      <Badge className={`${destination.status === 'Aktif' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'} mr-2`}>
                                        {destination.status}
                                      </Badge>
                                    ...
                                    <div className="flex items-center text-amber-500">
                                      ...
                                      <span className="text-xs text-gray-500 ml-1">({destination.reviewCount} ulasan)</span>
                                    </div>
                                  </div>
                                  
                                  <div className="mt-4 md:mt-0 text-right">
                                    <div className="text-sm text-gray-500">Harga Tiket</div>
                                    <div className="font-bold text-lg">Rp {destination.price.toLocaleString()}</div>
                                  </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                                  <div className="mb-3 md:mb-0">
                                    <div className="text-sm text-gray-500">Pemandu: {destination.guideCount} orang</div>
                                    <div className="text-sm text-gray-500 mt-1">Pengunjung bulan ini: {destination.visitorCount}</div>
                                  </div>
                                  ...
                                  <div className="flex space-x-2">
                                    ...
                                    <Link to={`/destination/edit/${destination.id}`}>
                                      <Button size="sm" variant="outline">
                          ...
                          <CardContent className="p-6">
                            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                              <div className="flex items-center mb-4 md:mb-0">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center text-amber-500 mb-1">
                                    ...
                                    <span className="text-xs text-gray-500 ml-1">({guide.reviewCount} ulasan)</span>
                                  </div>
                              ...
                              <div className="flex flex-col items-end">
                                <Badge className={`mb-3 ${guide.status === 'Aktif' ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800'}`}>
                                  {guide.status}
                                </Badge>
                                <div className="text-sm text-gray-500 mb-4">
                                  {guide.tourCount} tur bulan ini • {guide.completedTours} total tur
                                </div>
                                <div className="flex space-x-2">
                        ...
                        <Card>
                          <CardContent className="p-6">
                            <div className="h-[240px] flex items-center justify-center mb-4">
                              <BarChart3 size={80} className="text-gray-300" />
                              <div className="ml-4 text-gray-500">
                                <h3 className="font-medium">Data Grafik Pendapatan Bulanan</h3>
                                <p className="text-sm">Menampilkan pendapatan dan biaya per bulan</p>
                              </div>
                            </div>
                            
                            <div className="grid grid-cols-3 gap-4">
                              <div className="border rounded-lg p-4">
                                <div className="text-sm text-gray-500 mb-1">Pendapatan Kotor</div>
                                <div className="text-xl font-bold">Rp 45.600.000</div>
                              </div>
                              <div className="border rounded-lg p-4">
                                <div className="text-sm text-gray-500 mb-1">Biaya Operasional</div>
                                <div className="text-xl font-bold">Rp 12.400.000</div>
                              </div>
                              <div className="border rounded-lg p-4">
                                <div className="text-sm text-gray-500 mb-1">Pendapatan Bersih</div>
                                <div className="text-xl font-bold text-jelajah-green">Rp 33.200.000</div>
                              </div>
                            </div>
                          </CardContent>
                          <CardFooter>
...
const topDestinations = [
  ...
  },
  {
    ...
    location: "Ubud, Bali",
    image: "https://images.unsplash.com/photo-1592364395653-83e648b20cc2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dGVnYWxsYWxhbmd8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60",
    visitCount: 980,
  },
  {
    name: "Pantai Kuta",
...
const managedDestinations = [
  ...
  },
  {
    ...
    category: "Alam",
    location: "Ubud, Bali",
    image: "https://images.unsplash.com/photo-1578469550956-0e16b69c6a3d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8bW9ua2V5JTIwZm9yZXN0JTIwdWJ1ZHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60",
    price: 80000,
    rating: 4.6,
    reviewCount: 312,
    status: "Aktif",
